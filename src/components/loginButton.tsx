...
import { googleLoginStart } from "../features/auth/authSlice";
...
export default function LoginView(props: LoginViewProps) {
  ...
  function handleGoogleLogin(response:any) {
    ...
    const { tokenId }:any = response;
  
    // Dispatch the login action with the Google token
    // You may need to modify this action according to your Redux setup
    dispatch(googleLoginStart({ token: tokenId }));
  }
  return (
