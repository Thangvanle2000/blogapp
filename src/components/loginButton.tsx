...
export default function LoginView(props: LoginViewProps) {
  ...
  return (
    <div className="flex items-center justify-center space-x-4 mt-1">
      ...
      <button className="flex items-center py-2 px-4 text-sm uppercase rounded bg-white hover:bg-gray-300 text-indigo-500 border border-transparent hover:border-transparent hover:text-gray-700 shadow-md font-medium transition transform hover:-translate-y-0.5">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-6 h-6 mr-3"
          viewBox="0 0 48 48"
